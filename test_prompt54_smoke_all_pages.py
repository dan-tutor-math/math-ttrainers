...
Открывает каждую страницу (24 тренажёра, главную, доски и «калькуляторы в
...
def run():
    ...
    with local_server(), sync_playwright() as p:
        ...
        for slug in TRAINERS + OTHER:
            ...
            # с №61 — ОГЭ, часть 2 (та же страница)
            needs_bridge = slug in TRAINERS and slug not in ("oge8", "oge12", "powers", "ege_prof", "ege_base", "oge_part2")
